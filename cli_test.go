...
func Test_processCliFlags(t *testing.T) {
	...
	customFlags := CliFlags{
		...
		packetEventFilter: "10000",
		hostEventFilter:   "10000",
	...
	data := []struct {
		...
		{"default values", CliFlags{ifaceName: validIface.Name, packetEventFilter: "11111", hostEventFilter: "11111", expectedCidrRange: "0.0.0.0/0"}, true},
		...
		{"invalid package event filter flag", CliFlags{packetEventFilter: "00002", hostEventFilter: "11111"}, false},
		{"invalid host event filter len", CliFlags{packetEventFilter: "11111", hostEventFilter: "1111"}, false},
		{"invalid host event filter flag", CliFlags{packetEventFilter: "11111", hostEventFilter: "11112"}, false},
		{"nonexistent event dir", CliFlags{ifaceName: validIface.Name, eventDir: "nonexistent", packetEventFilter: "11111", hostEventFilter: "11111"}, false},
		{"missing iface", CliFlags{ifaceName: "", promiscMode: false, packetEventFilter: "11111", hostEventFilter: "11111"}, false},
